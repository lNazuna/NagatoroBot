...
client.on("channelCreate", async (channel) => {
    ...
    return Channel.send({
        embeds: [
            new EmbedBuilder()
            .setColor("#c5a0c1")
            .setTitle("<:discordchat:1084189534125834301> | Channel Criado")
            .setDescription("Um Channel foi criado")
            .addFields({ name: "Nome do Channel", value: `${channel.name} (<#${channel.id}>)`, inline: false})
